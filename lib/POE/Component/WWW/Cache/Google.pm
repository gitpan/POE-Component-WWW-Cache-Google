...
the C<event> argument to C<cache()> method/event will recieve input
...
Please report any bugs or feature requests to C<bug-poe-component-www-cache-google at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-WWW-Cache-Google>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-WWW-Cache-Google>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-WWW-Cache-Google>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-WWW-Cache-Google>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-WWW-Cache-Google>
